...
namespace MagicVilla.API.Controllers.v2
{
	...
	public class VillaNumberAPIv2Controller : ControllerBase
	{
		...
		public VillaNumberAPIv2Controller(IVillaNumberRepository villaNumberRepository, IMapper mapper, IVillaRepository villaRepository)
		{
		...
		public async Task<ActionResult<Response>> GetVillaNumbers()
		{
			try
			{
				IEnumerable<VillaNumber> villaNumbers = await _villaNumberRepository.GetAllAsync(includedProperties: "Villa");
		...
		public async Task<ActionResult<Response>> GetVillaNumber(int villaNo)
		{
			try
			{
				...
				var villaNumber = await _villaNumberRepository.GetAsync(v => v.VillaNo == villaNo, includedProperties: "Villa");
